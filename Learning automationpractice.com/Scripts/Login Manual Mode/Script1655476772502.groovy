...
WebUI.setText(findTestObject('Page_Login - My Store/input_Email address_email'), 'sara@testing.com')

WebUI.setText(findTestObject('Page_Login - My Store/input_Password_passwd'), 'sara123')
